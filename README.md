...
### <a href="https://esocr-api.herokuapp.com/" target="_blank">ESOCR API Demo</a> • <a href="https://github.com/ashfaqnisar/esocr-api" target="_blank">ESOCR API Repo</a>  •  <a href="https://esocr.now.sh" target="_blank">ESOCR Frontend Demo </a> • <a href="https://github.com/ashfaqnisar/esocr" target="_blank">ESOCR Frontend Repo</a>
...
## Installation
 ...
 2. **Install all of the fonts** from the fonts folder and **restart the system**.
 3.  You need to go to this **<a href="https://next.json-generator.com/V1OKEB2au">JSON Generator</a>** to **generate fake JSON data.**
 4. Copy the **fake JSON** and **place  it in the sample.json** file.
 5. Now, you need to open up the **[photoshop-script.jsx](https://github.com/ashfaqnisar/ESOCR-DATASET-GENERATOR/blob/master/photoshop-script.jsx "photoshop-script.jsx")** in any **file editor** and **modify the path**
 ```js
 var file = new File('yourPath/generatedImages/' + name + '.jpg');
 //sample
 //var file = new File('D:/Projects/OCR/images/generatedImages/' + name + '.jpg');
 ```
 6.  Now, you can either open up **placeHolder.psd** or **placeHolder_bestCase.psd** from the photoshop
 7. Once the psd is opened, you have to click on the **file ->  scripts -> browse** and select the **photoshop-script.jsx script** and it will **start producing the images** 
 8. The images will be stored in the **path specified** with the **index number**. 
